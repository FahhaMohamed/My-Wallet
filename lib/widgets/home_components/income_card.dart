...
Widget IncomeCard(BuildContext context,{required String userId}) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(
                  colors: [
                    Color.fromARGB(255, 165, 229, 106),
                    Color.fromARGB(255, 206, 229, 106),
                    Color.fromARGB(255, 165, 229, 106),
                  ],
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/home/income.jpg',color: Colors.black,
                width: 60,
              ...
              Text('${data['currency']} ${data['income']}',
